...
import { PersonalCard,CardSubtitle, CardText, CardImgDesk } from "./PersonalInfo.styled";
...
const PersonalInfoDesk: FC<PersonalInfoProps> = ({actor}) => {
const { id, name, profile_path, known_for_department, gender, birthday, place_of_birth, also_known_as }=actor;   
  ...
  return (     
   ...
   <PersonalCard key={id}>
      <CardImgDesk variant='top' src={`${BASE_IMG}${profile_path}`} alt={name} />
...
export default PersonalInfoDesk;
